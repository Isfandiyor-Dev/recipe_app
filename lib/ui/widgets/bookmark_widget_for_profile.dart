...
class BookmarkWidgetForProfile extends StatefulWidget {
  final List savedRecipes;
  final RecipeModel recipe;
  final String userId;
  const BookmarkWidgetForProfile(
      {super.key,
  ...
  @override
  State<BookmarkWidgetForProfile> createState() => _BookmarkWidgetState();
}

class _BookmarkWidgetState extends State<BookmarkWidgetForProfile> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Icon(
        Icons.bookmark,
        color:  widget.savedRecipes.contains(widget.recipe.id) ? Colors.blue : Colors.white,
        size: 30.0,
      ),
    );
  }
